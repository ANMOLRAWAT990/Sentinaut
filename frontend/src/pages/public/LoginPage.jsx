        ...
        <div className="w-full max-w-[400px] animate-in slide-in-from-bottom-4 fade-in duration-700 ease-out">
          ...
          <form className="space-y-8 mt-2" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4 pt-2">
              ...
              <Button type="button" variant="secondary" onClick={handleGoogleLogin} disabled={loading} className="w-full bg-white dark:bg-transparent text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900">
