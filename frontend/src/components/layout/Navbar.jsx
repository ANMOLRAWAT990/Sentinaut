          ...
          <>
            ...
            {user.role === 'owner' && (
              location.pathname === '/pricing'
                ? <Link to="/dashboard" className="hidden md:inline-block text-sm font-semibold text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 bg-primary-50 dark:bg-primary-900/30 px-3 py-1.5 rounded-lg transition-colors border border-primary-100 dark:border-primary-900/50 shadow-sm">Back to Dashboard</Link>
