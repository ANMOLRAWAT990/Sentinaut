      ...
      <div className="relative">
        ...
        {isPasswordInput && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-[#888888] hover:text-[#111111] dark:hover:text-[#ededed] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-black dark:focus-visible:ring-white rounded"
          >
